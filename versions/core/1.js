/**
 * @name Dissension
 * @author TheUncannyOrange
 * @description A discord mod that is technically not against the ToS
 * 
 * tutorial and further info: ()
 */
...
/*
  ...
  required by dissension (before it)
  - discord interface

  DISSENSION

  requires dissension (after it)
  - load
*/
...
const dissension = {
  ...
  let home = document.getElementsByClassName('tutorialContainer-2sGCg9')[0]
...
(function(){setTimeout(function(){ // init
  // apply style
